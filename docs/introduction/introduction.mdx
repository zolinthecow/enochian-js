...
typescript fully in mind. Enochian knows the full state of your program at any point in time, including the answers that were generated and the backend it's currently pointed to. You'll never
...
- Constrained decoding to force the LLM to follow any pattern you want (planned)
