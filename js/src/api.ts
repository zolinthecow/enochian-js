 ...
 */
type GenerateReqInputBase<S extends z.ZodType> = {
  ...
  sampling_params?: SamplingParams<S>;
  /** The request id. */
  rid?: string | string[];
 ...
 */
export type GenerateReqNonStreamingInput<S extends z.ZodType> =
  GenerateReqInputBase<S> & {
 ...
 */
export type GenerateReqStreamingInput<S extends z.ZodType> = Omit<
  GenerateReqInputBase<S>,
  "choices"
> & {
  stream: true;
 ...
 */
export type GenerateReqInput<S extends z.ZodType> =
  | GenerateReqNonStreamingInput<S>
  | GenerateReqStreamingInput<S>;

// DOCS COVERAGE: /api-reference/request-types
/**
 * Represents the sampling parameters for generation.
 */
export type SamplingParams<S extends z.ZodType> = {
